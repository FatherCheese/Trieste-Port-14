...
public sealed class FishMutationSystem : EntitySystem
{
    ...
    public void CheckRandomMutations(EntityUid plantHolder, ref FishEggData seed, float severity)
    {
    ...
    /// </summary>
    public void MutateSeed(EntityUid plantHolder, ref FishEggData seed, float severity)
    {
        if (!seed.Unique)
        {
    ...
    public FishEggData Cross(FishEggData a, FishEggData b)
    {
        FishEggData result = b.Clone();
        ...
        CrossBool(ref result.Eggless, a.Eggless);
    ...
    private void CrossChemicals(ref Dictionary<string, FishEggChemQuantity> val, Dictionary<string, FishEggChemQuantity> other)
    {
